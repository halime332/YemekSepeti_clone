...
const ProductCard = ({item}) => {
  ...
  return (
    <div className="grid grid-cols-[1fr_115px]  gap-3 border shadow rounded-lg 
    hover:bg-red-100 hover:scale -[1.02] cursor-pointer transition duration-300">
       <div className="flex flex-col justify-between">
        ...
        <div className=" relative ">
            ...
            <button onClick={handleAdd} className="absolute end-2 bottom-2 bg-white 
               rounded-full hover:bg-red-100 size-8 grid place-items-center font-semibold">
